  ...
  <a-card :bordered="false">
    ...
    <a-modal v-model="visible" title="操作" :width="800" @ok="handleOk">
      ...
      >
        ...
        <a-form-item :label-col="labelCol" :wrapper-col="wrapperCol" label="赋予权限" has-feedback>
          <a-select v-model="mdl.actions" style="width: 100%;" mode="multiple" :allow-clear="true">
