    ...
    <a-spin :spinning="confirmLoading">
      ...
      <a-form :form="form">
        ...
        <div v-show="currentStep === 0">
          <a-form-item label="规则名称" :label-col="labelCol" :wrapper-col="wrapperCol">
            <a-input v-decorator="['name', { rules: [{ required: true }] }]" />
          </a-form-item>
          <a-form-item label="规则描述" :label-col="labelCol" :wrapper-col="wrapperCol">
            <a-textarea v-decorator="['desc', { rules: [{ required: true }] }]" :rows="4"></a-textarea>
          </a-form-item>
        </div>
        <div v-show="currentStep === 1">
          <a-form-item label="监控对象" :label-col="labelCol" :wrapper-col="wrapperCol">
          ...
          <a-form-item label="规则模板" :label-col="labelCol" :wrapper-col="wrapperCol">
          ...
          <a-form-item label="规则类型" :label-col="labelCol" :wrapper-col="wrapperCol">
            <a-radio-group
        ...
        <div v-show="currentStep === 2">
          ...
          <a-form-item label="调度周期" :label-col="labelCol" :wrapper-col="wrapperCol">
            <a-select
