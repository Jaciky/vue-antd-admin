<template>
  <div>
    <a-form :form="form" style="max-width: 500px; margin: 40px auto 0;">
      <a-form-item label="付款账户" :label-col="labelCol" :wrapper-col="wrapperCol">
        <a-select
      ...
      <a-form-item label="收款账户" :label-col="labelCol" :wrapper-col="wrapperCol">
      ...
      <a-form-item label="收款人姓名" :label-col="labelCol" :wrapper-col="wrapperCol">
        <a-input
          v-decorator="['name', { initialValue: 'Alex', rules: [{ required: true, message: '收款人名称必须核对' }] }]"
        />
      </a-form-item>
      <a-form-item label="转账金额" :label-col="labelCol" :wrapper-col="wrapperCol">
        <a-input
